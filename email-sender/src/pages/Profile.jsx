...
const Profile = () => {
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        const { data } = await fetchData("http://localhost:5000/stats");
        setStats({
          ...data,
        ...
        >
          ...
          <div className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
              {/* Email Campaign Card */}
              <NavLink to="/dashboard/start-campaign">
                <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg">
            ...
            <div className="flex flex-col gap-3">
              ...
              <NavLink to="/dashboard/add-contact">
                <button className="w-full flex items-center p-4 rounded-xl bg-emerald-50 hover:bg-emerald-100 transition-colors">
